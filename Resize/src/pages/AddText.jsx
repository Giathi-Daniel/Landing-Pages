...
const AddText = () => {
  ...
  return (
    <>
      <section className="relative bg-dark lg:px-[3rem] px-4 border border-b-borderLight border-t-0 border-l-0 flex flex-col md:flex-row items-center justify-between h-[87vh]">
      ...
      {/* CONVERT CONTENT */}
      <section id="features" className="grid md:grid-cols-2 grid-cols-1 md:gap-6 gap-[3rem] py-10 lg:px-[4rem] px-4 mb-[-2rem]">
      ...
      {/* TOOLS */}
      <section className="flex flex-col justify-center lg:px-[4rem] px-4 mb-[-1rem]">
