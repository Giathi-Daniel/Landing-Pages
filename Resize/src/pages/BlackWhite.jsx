...
const BlackWhite = () => {
  ...
  return (
    <>
      <section className="relative bg-dark lg:px-[6rem] px-4 border border-b-borderLight border-t-0 border-l-0 flex flex-col md:flex-row items-center justify-between ">
